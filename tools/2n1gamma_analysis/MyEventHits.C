...
MyEventHits::MyEventHits()
{
    ...
    hRootEdepSum511kev = new TH1F("hRootEdepSum511kev", "hRootEdepSum511kev", 200, 0.0, 1.2);
    ...
    hRootEdepSumSmear511kev = new TH1F("hRootEdepSumSmear511kev", "hRootEdepSumSmear511kev", 200, 0.0, 1.2);
